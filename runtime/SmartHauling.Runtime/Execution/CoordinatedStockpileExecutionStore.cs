...
/// <summary>
/// Active drop reservation chosen by the executor for a specific resource and storage cell.
/// </summary>
...
/// <summary>
/// Mutable execution state for a coordinated stockpile hauling goal.
/// </summary>
/// <remarks>
/// This state tracks executor-only concerns such as current drop target, retry counters, sticky
/// phase locks, and pickup locality anchors. Planning data belongs in <see cref="CoordinatedStockpileTask"/>.
/// </remarks>
...
/// <summary>
/// Goal-scoped storage for mutable executor state.
/// </summary>
internal static class CoordinatedStockpileExecutionStore
{
    ...
    /// <summary>
    /// Gets or creates the execution state for a goal.
    /// </summary>
    ...
    /// <summary>
    /// Returns the existing execution state if the goal has already entered the custom executor flow.
    /// </summary>
